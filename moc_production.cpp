...
**
** Created: Thu Jun 27 12:46:52 2013
...
static const char qt_meta_stringdata_production[] = {
    "production\0\0refresh()\0"
};
...
const QMetaObjectExtraData production::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject production::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_production,
      qt_meta_data_production, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &production::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_production))
